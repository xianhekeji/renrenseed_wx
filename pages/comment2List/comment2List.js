...
var url_getPinglun = getApp().globalData.constUrl +"mobileinterface/api/GetCommentByRecordId.php";
var url_send = getApp().globalData.constUrl +"mobileinterface/api/AddNewCommend2Data.php";
