(function () {
  ...
  function getImageData(img, callback) {
    ...
    if (img) {
      ...
      var arrayBuffer = reader.readAsArrayBuffer(blob);
      handleBinaryFile(arrayBuffer);
      //reader.readAsArrayBuffer(new Blob(img)) 
  ...
  EXIF.getData = function (img, callback) {
    ...
    if (!imageHasData(img)) {
      getImageData(img, function (callback) {
